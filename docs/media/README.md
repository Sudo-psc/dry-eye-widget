...
- `carousel-dark.gif` / `carousel-light.gif` — carrossel animado das **telas
  reais** (GIF), nas variantes escura e clara; embutidos via `<picture>` com
  `prefers-color-scheme` (acompanha o tema do GitHub do leitor).
